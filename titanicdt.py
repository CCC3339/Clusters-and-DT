...
#Change data into number values
for dataset in data:
...
sns.violinplot(x='IsAlone',y='Survived',data=train)

g = sns.FacetGrid(train, col="Survived")
g.map(sns.histplot, "FS")

grid = sns.FacetGrid(train, row = 'Embarked', size = 3, aspect = 2.5)
grid.map(sns.pointplot, 'Pclass', 'Survived', 'Sex', palette = 'deep')
grid.add_legend()

sns.stripplot(x = 'Pclass', y = 'Fare', data = train)
...
print("Fare: paid<£40 - 0 , £40<paid>70 - 1 , 70<paid>100 - 2 , paid>100 - 3")
